import { numbarFormat } from "~/utils/formats";

export default function Post({ post }) {
  return (
    <div className="px4 py-3 gap-3 border-b border-[color:var(--background-third)] flex relative before:absolute before:z-[-1] before:transition-colors before:inset-0 before:opacity-50 before:hover:bg-[color:var(--background-secondary)]">
      <img
      ...
      <div className="flex-1">
        <header className="leading-5 flex items-center gap-2 mb-0.5">
          ...
          <div className="text-[color:var(--color-base-secondary)] flex items-center gap-1">
          ...
          <div className="flex -ml-1.5 mt-1.5">
            <div className="flex-1 group flex items-center gap-px">
              ...
              <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0]">
                {numbarFormat(post.stats.comments)}
              </span>
            </div>
            ...
            <div className="flex-1 group flex items-center gap-px">
              ...
              <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#00ba7c]">
                {numbarFormat(post.stats.repost)}
              </span>
            </div>
