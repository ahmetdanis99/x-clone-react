...
import { colors, fontsSizes } from "~/utils/const";
        ...
        <div>
          <div className="grid gap-3">
              ...
              <div className="bg-[color:var(--background-secondary)] rounded-2xl p-4 flex items-center gap-5">
                ...
                <div className="h-1 bg-[color:var(--color-secondary)] flex-1 rounded-full relative">
                  <div
                    ...
                    className="top-0 left-0 absolute rounded-full bg-[color:var(--color-primary)] h-full"
                  />
                  <div className="flex justify-between absolute w-[calc(100%+16px)] -top-3.5 -left-[8px]">
                    {fontsSizes.map((fs) => (
                      <button
                        type="button"
                        onClick={(e) => setFontSize(fs)}
            ...
            <section>
              ...
              <div className="bg-[color:var(--background-secondary)] rounded-2xl py-2 flex justify-around items-center">
                {colors.map((c, index) => (
                  <button
                    key={index}
                    onClick={() =>
            ...
            <section>
              <h6 className="text-[color:var(--color-base-secondary)] mb-1 leading-5 text-[13px] font-bold">
                <div className="truncate">Arka plan</div>
              </h6>
              <div className="py-1 px-4 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl">
                <button
                  onClick={() => {
                    setColor({
                      ...color,
