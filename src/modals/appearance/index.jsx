  ...
  return (
    <div className="w-[600px] ">
      ...
      <div className="p-8 pt-0">
        <p className="text-center text-[color:var(--color-base)] leading-5 text-[15px] mb-5">
          Bu ayarlar, bu tarayıcıdaki tüm X hesaplarını etkiler.
        </p>
        <div className="mx-8 pt-0">
          ...
          <div className="py-1 px-3 mb-3 grid grid-cols-3 gap-1 bg-[color:var(--background-secondary)] rounded-2xl">
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-white text-[#0f1419] font-bold border-2 border-transparent rounded",
                {
            ...
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-[#15202b] text-[#f7f9f9] font-bold border-2 border-transparent rounded",
                {
                  "border-[color:var(--color-primary)] ":
            ...
            <button
              ...
              className={classNames(
                "h-16 px-5 bg-black text-[#f7f9f9] font-bold border-2 border-transparent rounded",
                {
                  "border-[color:var(--color-primary)]":
